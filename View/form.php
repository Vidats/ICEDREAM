...
<head>
    ...
    :root {
        ...
        --text-color: #444;
        --light-bg: #fff5f7;        /* Nền hồng cực nhẹ */
        --ice-pink: #ff85a2;
        --ice-blue: #a2d2ff;
        --text-dark: #2d3436;
    }
    ...
    /* Label và Input */
    label { font-weight: 600; color: var(--text-dark); margin-bottom: 8px; font-size: 0.9rem; }
    ...
    input:focus { outline: none; border-color: var(--ice-pink); background-color: #fffafa; }
    ...
    .col-md-6 { flex: 1; }
    .error-message { color: var(--ice-pink); font-size: 0.8rem; }
    
    /* Checkbox & Link */
    .form-check-label a { color: var(--ice-pink); font-weight: 600; }
    .forgot-password-link { color: var(--ice-blue); text-decoration: none; font-weight: 600; }
</style>
</head>
<body>
...
<a href="forgot-password-view.php" class="float-end forgot-password-link">Quên mật khẩu?</a>                    </div>
...
<form id="registerForm" method="POST" action="../Controller/registration.php">                    <input type="hidden" name="action" value="register"> 
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <span class="error-message" id="reg-confirm-email-error"></span>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 form-group">
                            ...
                            <select class="form-control" id="register-title" name="title" required>
                                <option value="" disabled selected>Chọn danh xưng</option>
                    ...
                    <div class="form-check text-start mb-4">
                        ...
                        <label class="form-check-label" for="privacy-policy" style="font-weight: normal; font-size: 0.95rem; color:#000000">
                            Tôi đã đọc và đồng ý với <a href="pl.html" style=" font-weight: 500; color: #000000;">Chính sách quyền riêng tư</a>. *
                        </label>
                    </div>
